            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "a5a66a47-0611-48fb-b59c-85b2e0858dd3",
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Dob")
                        ...
                        .HasDefaultValue(new DateTime(2022, 7, 28, 15, 29, 47, 798, DateTimeKind.Local).AddTicks(1471));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "67a75fb3-1564-474c-847a-db888edcba04",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJZnLKOkv7+GOzEVwrT3bB8IhwPiCL13XwdD7yzbaAR18Kf8CmrzcRuKOINzo0IwJQ==",
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.Debt", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDateDebt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 15, 29, 47, 793, DateTimeKind.Local).AddTicks(3236));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreateDateDebt = new DateTime(2022, 7, 28, 15, 29, 47, 810, DateTimeKind.Local).AddTicks(2763),
                            GuestID = "KH01",
                            ProductID = "PR01",
                            TotalDebt = 90000m
                        },
                        ...
                        {
                            ID = 2,
                            CreateDateDebt = new DateTime(2022, 7, 28, 15, 29, 47, 810, DateTimeKind.Local).AddTicks(3769),
                            GuestID = "KH02",
                            ProductID = "PR02",
                            TotalDebt = 55000m
                        });
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.Employee", b =>
                {
                    ...
                    b.Property<DateTime>("Dob")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 15, 29, 47, 796, DateTimeKind.Local).AddTicks(6845));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Dob = new DateTime(2022, 7, 28, 15, 29, 47, 810, DateTimeKind.Local).AddTicks(7813),
                        ...
                        {
                            ID = 2,
                            Dob = new DateTime(2022, 7, 28, 15, 29, 47, 810, DateTimeKind.Local).AddTicks(8683),
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.ExportProduct", b =>
                {
                    ...
                    b.Property<DateTime>("ExDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 15, 29, 47, 792, DateTimeKind.Local).AddTicks(1904));
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ExDate = new DateTime(2022, 7, 28, 15, 29, 47, 810, DateTimeKind.Local).AddTicks(6212),
                            Quantity = 32,
                            SalesPrice = 120000m,
                            ToTalSum = 32m,
                            debttotal = 0m,
                        ...
                        {
                            Id = 2,
                            ExDate = new DateTime(2022, 7, 28, 15, 29, 47, 810, DateTimeKind.Local).AddTicks(7000),
                            Quantity = 20,
                            SalesPrice = 125000m,
                            ToTalSum = 20m,
                            debttotal = 0m,
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.Guest", b =>
                {
                    ...
                    b.Property<DateTime>("Dob")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 15, 29, 47, 797, DateTimeKind.Local).AddTicks(5894));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = "KH01",
                            Dob = new DateTime(2022, 7, 28, 15, 29, 47, 808, DateTimeKind.Local).AddTicks(9120),
                        ...
                        {
                            ID = "KH02",
                            Dob = new DateTime(2022, 7, 28, 15, 29, 47, 809, DateTimeKind.Local).AddTicks(57),
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.ImportProduct", b =>
                {
                    ...
                    b.Property<DateTime>("ImportDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 15, 29, 47, 785, DateTimeKind.Local).AddTicks(8624));
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "PR01",
                            ImportDate = new DateTime(2022, 7, 28, 15, 29, 47, 810, DateTimeKind.Local).AddTicks(4238),
                            Name = "Dầu Gội Đầu",
                            OriginPrice = 125000m,
                            Quantity = 32,
                            SalesPrice = 120000m,
                        ...
                        {
                            Id = "PR02",
                            ImportDate = new DateTime(2022, 7, 28, 15, 29, 47, 810, DateTimeKind.Local).AddTicks(5660),
                            Name = "Lọ thủy tinh",
                            OriginPrice = 150000m,
                            Quantity = 20,
                            SalesPrice = 125000m,

            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "1fc2fa29-aba0-43c8-ac6c-8353fc287730",
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Dob")
                        ...
                        .HasDefaultValue(new DateTime(2022, 7, 28, 16, 44, 37, 31, DateTimeKind.Local).AddTicks(1614));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2bc67667-5a5d-4cb0-a09f-8e9acdb69b26",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEOx+nQQYlwZ9KrI9Mj3u5zXE3Zjab+M42jYBYadEBDVZWbgRw5huWG3AS5EXm3+Xrg==",
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.Debt", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDateDebt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 16, 44, 37, 26, DateTimeKind.Local).AddTicks(5956));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreateDateDebt = new DateTime(2022, 7, 28, 16, 44, 37, 38, DateTimeKind.Local).AddTicks(1538),
                            GuestID = "KH01",
                            ProductID = "PR01",
                            TotalDebt = 90000m
                        },
                        ...
                        {
                            ID = 2,
                            CreateDateDebt = new DateTime(2022, 7, 28, 16, 44, 37, 38, DateTimeKind.Local).AddTicks(2262),
                            GuestID = "KH02",
                            ProductID = "PR02",
                            TotalDebt = 55000m
                        });
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.Employee", b =>
                {
                    ...
                    b.Property<DateTime>("Dob")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 16, 44, 37, 29, DateTimeKind.Local).AddTicks(8529));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Dob = new DateTime(2022, 7, 28, 16, 44, 37, 38, DateTimeKind.Local).AddTicks(5254),
                        ...
                        {
                            ID = 2,
                            Dob = new DateTime(2022, 7, 28, 16, 44, 37, 38, DateTimeKind.Local).AddTicks(6147),
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.ExportProduct", b =>
                {
                    ...
                    b.Property<DateTime>("ExDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 16, 44, 37, 25, DateTimeKind.Local).AddTicks(5162));
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ExDate = new DateTime(2022, 7, 28, 16, 44, 37, 38, DateTimeKind.Local).AddTicks(3985),
                            Quantity = 32,
                            SalesPrice = 120000m,
                            ToTalSum = 32m,
                            debttotal = 0m,
                        ...
                        {
                            Id = 2,
                            ExDate = new DateTime(2022, 7, 28, 16, 44, 37, 38, DateTimeKind.Local).AddTicks(4637),
                            Quantity = 20,
                            SalesPrice = 125000m,
                            ToTalSum = 20m,
                            debttotal = 0m,
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.Guest", b =>
                {
                    ...
                    b.Property<DateTime>("Dob")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 16, 44, 37, 30, DateTimeKind.Local).AddTicks(6307));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = "KH01",
                            Dob = new DateTime(2022, 7, 28, 16, 44, 37, 37, DateTimeKind.Local).AddTicks(2774),
                        ...
                        {
                            ID = "KH02",
                            Dob = new DateTime(2022, 7, 28, 16, 44, 37, 37, DateTimeKind.Local).AddTicks(3246),
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.ImportProduct", b =>
                {
                    ...
                    b.Property<DateTime>("ImportDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 16, 44, 37, 20, DateTimeKind.Local).AddTicks(638));
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "PR01",
                            ImportDate = new DateTime(2022, 7, 28, 16, 44, 37, 38, DateTimeKind.Local).AddTicks(2561),
                            Name = "Dầu Gội Đầu",
                            OriginPrice = 125000m,
                            Quantity = 32,
                            SalesPrice = 120000m,
                        ...
                        {
                            Id = "PR02",
                            ImportDate = new DateTime(2022, 7, 28, 16, 44, 37, 38, DateTimeKind.Local).AddTicks(3574),
                            Name = "Lọ thủy tinh",
                            OriginPrice = 150000m,
                            Quantity = 20,
                            SalesPrice = 125000m,

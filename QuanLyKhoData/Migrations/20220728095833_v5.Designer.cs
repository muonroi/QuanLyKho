            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "2811d390-4f93-4f3e-aa1c-186b76ba969d",
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Dob")
                        ...
                        .HasDefaultValue(new DateTime(2022, 7, 28, 16, 58, 32, 559, DateTimeKind.Local).AddTicks(6990));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d04d0652-799e-40af-82e1-5c2945ff6413",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEPLQfA4jeZMeC+62Oqy1B69PW8xZ6uC1xIDEknLtHZ7IthhmNXUnjpxzA7dQb2AfrA==",
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.Debt", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDateDebt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 16, 58, 32, 555, DateTimeKind.Local).AddTicks(1438));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreateDateDebt = new DateTime(2022, 7, 28, 16, 58, 32, 565, DateTimeKind.Local).AddTicks(5661),
                            GuestID = "KH01",
                            ProductID = "PR01",
                            TotalDebt = 90000m
                        },
                        ...
                        {
                            ID = 2,
                            CreateDateDebt = new DateTime(2022, 7, 28, 16, 58, 32, 565, DateTimeKind.Local).AddTicks(6388),
                            GuestID = "KH02",
                            ProductID = "PR02",
                            TotalDebt = 55000m
                        });
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.Employee", b =>
                {
                    ...
                    b.Property<DateTime>("Dob")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 16, 58, 32, 558, DateTimeKind.Local).AddTicks(4737));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Dob = new DateTime(2022, 7, 28, 16, 58, 32, 565, DateTimeKind.Local).AddTicks(9463),
                        ...
                        {
                            ID = 2,
                            Dob = new DateTime(2022, 7, 28, 16, 58, 32, 566, DateTimeKind.Local).AddTicks(223),
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.ExportProduct", b =>
                {
                    ...
                    b.Property<DateTime>("ExDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 16, 58, 32, 554, DateTimeKind.Local).AddTicks(1427));
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ExDate = new DateTime(2022, 7, 28, 16, 58, 32, 565, DateTimeKind.Local).AddTicks(8091),
                            Quantity = 32,
                            SalesPrice = 120000m,
                            ToTalSum = 32m,
                            debttotal = 0m,
                        ...
                        {
                            Id = 2,
                            ExDate = new DateTime(2022, 7, 28, 16, 58, 32, 565, DateTimeKind.Local).AddTicks(8836),
                            Quantity = 20,
                            SalesPrice = 125000m,
                            ToTalSum = 20m,
                            debttotal = 0m,
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.Guest", b =>
                {
                    ...
                    b.Property<DateTime>("Dob")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 16, 58, 32, 559, DateTimeKind.Local).AddTicks(2222));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = "KH01",
                            Dob = new DateTime(2022, 7, 28, 16, 58, 32, 564, DateTimeKind.Local).AddTicks(7679),
                        ...
                        {
                            ID = "KH02",
                            Dob = new DateTime(2022, 7, 28, 16, 58, 32, 564, DateTimeKind.Local).AddTicks(8146),
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.ImportProduct", b =>
                {
                    ...
                    b.Property<DateTime>("ImportDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 16, 58, 32, 549, DateTimeKind.Local).AddTicks(985));
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "PR01",
                            ImportDate = new DateTime(2022, 7, 28, 16, 58, 32, 565, DateTimeKind.Local).AddTicks(6707),
                            Name = "Dầu Gội Đầu",
                            OriginPrice = 125000m,
                            Quantity = 32,
                            SalesPrice = 120000m,
                        ...
                        {
                            Id = "PR02",
                            ImportDate = new DateTime(2022, 7, 28, 16, 58, 32, 565, DateTimeKind.Local).AddTicks(7669),
                            Name = "Lọ thủy tinh",
                            OriginPrice = 150000m,
                            Quantity = 20,
                            SalesPrice = 125000m,

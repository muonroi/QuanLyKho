            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "75e04dda-ed0c-4f54-8ed8-59a91de16351",
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Dob")
                        ...
                        .HasDefaultValue(new DateTime(2022, 7, 28, 15, 33, 9, 514, DateTimeKind.Local).AddTicks(3590));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c8cb205b-8a77-41b6-84d2-55056458864f",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEDtmAlOYuxC+lXqO4C29hCjePDz0G/5czpn+n7T0A7gq8ZQS/XI0NbEpAachw/TanQ==",
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.Debt", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDateDebt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 15, 33, 9, 510, DateTimeKind.Local).AddTicks(1944));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreateDateDebt = new DateTime(2022, 7, 28, 15, 33, 9, 522, DateTimeKind.Local).AddTicks(3435),
                            GuestID = "KH01",
                            ProductID = "PR01",
                            TotalDebt = 90000m
                        },
                        ...
                        {
                            ID = 2,
                            CreateDateDebt = new DateTime(2022, 7, 28, 15, 33, 9, 522, DateTimeKind.Local).AddTicks(4223),
                            GuestID = "KH02",
                            ProductID = "PR02",
                            TotalDebt = 55000m
                        });
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.Employee", b =>
                {
                    ...
                    b.Property<DateTime>("Dob")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 15, 33, 9, 513, DateTimeKind.Local).AddTicks(1210));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Dob = new DateTime(2022, 7, 28, 15, 33, 9, 522, DateTimeKind.Local).AddTicks(7419),
                        ...
                        {
                            ID = 2,
                            Dob = new DateTime(2022, 7, 28, 15, 33, 9, 522, DateTimeKind.Local).AddTicks(8154),
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.ExportProduct", b =>
                {
                    ...
                    b.Property<DateTime>("ExDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 15, 33, 9, 509, DateTimeKind.Local).AddTicks(2435));
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ExDate = new DateTime(2022, 7, 28, 15, 33, 9, 522, DateTimeKind.Local).AddTicks(6128),
                            Quantity = 32,
                            SalesPrice = 120000m,
                            ToTalSum = 32m,
                            debttotal = 0m,
                        ...
                        {
                            Id = 2,
                            ExDate = new DateTime(2022, 7, 28, 15, 33, 9, 522, DateTimeKind.Local).AddTicks(6781),
                            Quantity = 20,
                            SalesPrice = 125000m,
                            ToTalSum = 20m,
                            debttotal = 0m,
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.Guest", b =>
                {
                    ...
                    b.Property<DateTime>("Dob")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 15, 33, 9, 513, DateTimeKind.Local).AddTicks(8630));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = "KH01",
                            Dob = new DateTime(2022, 7, 28, 15, 33, 9, 521, DateTimeKind.Local).AddTicks(4555),
                        ...
                        {
                            ID = "KH02",
                            Dob = new DateTime(2022, 7, 28, 15, 33, 9, 521, DateTimeKind.Local).AddTicks(5044),
            ...
            modelBuilder.Entity("QuanLyKhoData.Entities.ImportProduct", b =>
                {
                    ...
                    b.Property<DateTime>("ImportDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 28, 15, 33, 9, 504, DateTimeKind.Local).AddTicks(1614));
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "PR01",
                            ImportDate = new DateTime(2022, 7, 28, 15, 33, 9, 522, DateTimeKind.Local).AddTicks(4526),
                            Name = "Dầu Gội Đầu",
                            OriginPrice = 125000m,
                            Quantity = 32,
                            SalesPrice = 120000m,
                        ...
                        {
                            Id = "PR02",
                            ImportDate = new DateTime(2022, 7, 28, 15, 33, 9, 522, DateTimeKind.Local).AddTicks(5694),
                            Name = "Lọ thủy tinh",
                            OriginPrice = 150000m,
                            Quantity = 20,
                            SalesPrice = 125000m,
